                                                                       ...
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                        ...
                                                                        <div class='col-xs-12 col-sm-2 col-md-2 col-lg-2'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>A&NtildeO:MES:DIA<span class="color-rojo"> (*)</span></label> </div>
                                                                                <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtedadpacifuat' id='txtedadpacifuat' tabindex='4'  maxlength='20'>
                                                                        </div>
                                              <!--                   
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                              ...
                                                              <div class='col-xs-11 col-sm-11 col-md-11 col-lg-11'>
                                                                 ...
                                                                 <div class='row'>
                                                                                <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                                                      ...
                                                                                      <input type='text' class='col-xs-12 col-sm-12 col-md-12 col-lg-12 form-control' name='txtdirepacifuat' id='txtdirepacifuat'  tabindex='16' maxlength='1000'>
                                                                                </div>
                                                              ...
                                                              <div class='col-xs-11 col-sm-11 col-md-11 col-lg-11'>
                                                                 ...
                                                                 <div class='row' id='divrefe'>
                                                                                ...
                                                                                <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                                  ...
                                                                                  <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtnrohojarefefuat' id='txtnrohojarefefuat'  tabindex='20'  maxlength='10'>
                                                                                </div>
                                                                                <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                                  <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>FECHA DE REFERENCIA</label> </div>
                                                                                  <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtfecharefefuat' id='txtfecharefefuat'  tabindex='21'  maxlength='10'>
                                                                                </div>
                                                                 </div>
                                                             </div>     
                                                          </div> 
                                                                  ...
                                                                  <div class='row'>    
                                                                        ...
                                                                        <div class='col-xs-12 col-sm-9 col-md-9 col-lg-9'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>APELLIDOS, NOMBRE(S) Y DNI <span class="color-rojo"> (*)</span></label> </div>
                                                                              <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtnomapofuat' id='txtnomapofuat'  tabindex='25'  maxlength='200'>
                                                                        </div>
                                                              <!--    
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>TIPO_DOCUMENTO<span class="color-rojo"> (*)</span></label> </div>
                                                                 ...
                                                                 <div class='row'>    
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>CORREO_ELECTRONICO<span class="color-rojo"> (*)</span></label> </div>
                                                                                <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtcorreoapofuat' id='txtcorreoapofuat'  tabindex='26' maxlength='200'>
                                                                       </div>
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>CELULAR<span class="color-rojo"> (*)</span></label> </div>
                                                                            <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtceluapofuat' id='txtceluapofuat'  tabindex='27'  maxlength='20'>
                                                                       </div>
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>TELEFONO</label> </div>
                                                                                <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtteleapofuat' id='txtteleapofuat'  tabindex='28' maxlength='20'>
                                                                        </div>
                                                                       ...
                                                                       -->
                                                                        <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label' id='lblapepatmatnom'>APELLIDOS, NOMBRE(S) Y DNI DEL PADRE Y/O MADRE<span class="color-rojo"> (*)</span></label> </div>
                                                                                <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtapepatmatnomapofuat' id='txtapepatmatnomapofuat'  tabindex='29' maxlength='200'>
                                                                        </div>
                                                                 </div>
                                                             </div>
                                                        </div>
                                                        ...
                                                        <div class='panel-primary col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                              ...
                                                              <div class='col-xs-11 col-sm-11 col-md-11 col-lg-11'>
                                                                ...
                                                                <br>
                                                                  <div class='row'>
                                                                      <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                                            <textarea  class='col-xs-12 col-sm-12 col-md-12 col-lg-12 form-control'  name='textdetasolicita' id='textdetasolicita'  rows='5' tabindex='30' maxlength='1950'>
                                                              ...
                                                              <div class='col-xs-11 col-sm-11 col-md-11 col-lg-11'>
                                                                ...
                                                                <br>
                                                                  <div class='row'>
                                                                        ...
                                                                        <div class='col-xs-12 col-sm-9 col-md-9 col-lg-9'>
                                                                                <textarea  class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtobsaceptasolicitafuat' id='txtobsaceptasolicitafuat'  tabindex='33' maxlength='2000' rows='4'>
                                                                                </textarea>
