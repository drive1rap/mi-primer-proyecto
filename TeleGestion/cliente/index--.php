                    ...
                    <div class='panel-body'>
                      ...
                      <div class="row">
                          <div class='col-xs-12 col-sm-2 col-md-2 col-lg-2'>
                              ...
                              <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtfechaini' id='txtfechaini'  tabindex='35' maxlength='10' >
                        
                          </div> 
                          <div class='col-xs-12 col-sm-2 col-md-2 col-lg-2'>
                              <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label' align="left">Fecha Final:</label>
                              <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtfechafin' id='txtfechafin'  tabindex='36' maxlength='10' >
                                    ...
                                    <thead>
                                        <tr class='primary' style='font-size:13px;'>
                                           ...
                                           <th>Materno</th>
                                            ...
                                            <th class='invisible'>Tratamiento_Actual</th>
                                            <th class='invisible'>Examen_de_Apoyo</th>
                                      ...
                                      <div class='modal-content'>
                                           <div class='modal-header'>
                                                              ...
                                                              <div class='col-xs-11 col-sm-11 col-md-11 col-lg-11'>
                                                                  <div class='row'>    
                                                                       ...
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            ...
                                                                            <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtdnipacifuat' id='txtdnipacifuat'  tabindex='2' maxlength='20'>
                                                                        </div>
                                                                       ...
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>FECHA_NACIMIENTO<span class="color-rojo"> (*)</span></label> </div>
                                                                             <input class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtfechanacipacifuat' id='txtfechanacipacifuat'  type='text' tabindex='3'  maxlength='10'>
                                                                        </div>
                                              <!--                   
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                            ...
                                            -->
                                                                 ...
                                                                 <div class='row'>    
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>NOMBRE(S)</label> </div>
                                                                              <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtnompacifuat' id='txtnompacifuat'  tabindex='5' maxlength='100'>
                                                                        </div>
                                                                
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>APELLIDO_PATERNO</label> </div>
                                                                             <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtapepatpacifuat' id='txtapepatpacifuat'  tabindex='6' maxlength='50'>
                                                                        </div>
                                                                
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>APELLIDO_MATERNO</label> </div>
                                                                                <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtapematpacifuat' id='txtapematpacifuat'  tabindex='7'  maxlength='50'>
                                                                        </div>
                                                                
                                                                       <div class='col-xs-12 col-sm-2 col-md-2 col-lg-2'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>SEXO</label> </div>
                                                                        ...
                                                                        <div class='col-xs-12 col-sm-1 col-md-1 col-lg-1'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>EDAD</label> </div>
                                                                                <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtedadpacifuat' id='txtedadpacifuat'  tabindex='9'  maxlength='2'>
                                                                        </div>
                                                                 </div>
                                                             ...
                                                             <div> <H5><label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label color-rojo'><br><br> PROCEDENCIA:</label></H4> </div>
                                                              <div class='col-xs-11 col-sm-11 col-md-11 col-lg-11'>
                                                                  <div class='row'>
                                                                                <div class='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                                                                                   <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>DEPARTAMENTO<span class="color-rojo"> (*)</span></label></div>
                                                                                    <select class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='cbodepapacifuat' id='cbodepapacifuat' tabindex='10' >
                                                                                      <option value='' selected='true'>
                                                                                    </select>
                                                                                ...
                                                                                <div class='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                                                                                  ...
                                                                                  <select class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='cboprovpacifuat' id='cboprovpacifuat' tabindex='11' >
                                                                                    <option value='' selected='true'>
                                                                                  </select>
                                                                                </div>
                                                                                <div class='col-xs-12 col-sm-4 col-md-4 col-lg-4'>
                                                                                     <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>DISTRITO<span class="color-rojo"> (*)</span></label></div>
                                                                                    <select class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='cbodistripacifuat' id='cbodistripacifuat' tabindex='12' >
                                                                                      <option value='' selected='true'>
                                                                                    </select>
                                                                                </div>
                                                                 </div>
                                                                 ...
                                                                 <div class='row'>
                                                                                <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                                                      ...
                                                                                      <input type='text' class='col-xs-12 col-sm-12 col-md-12 col-lg-12 form-control' name='txtdirepacifuat' id='txtdirepacifuat'  tabindex='13' maxlength='1000'>
                                                                                </div>
                                                              ...
                                                              <div class='col-xs-11 col-sm-11 col-md-11 col-lg-11'>
                                                                  <div class='row'>
                                                                                <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                                   <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>DEPARTAMENTO<span class="color-rojo"> (*)</span></label></div>
                                                                                    <select class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='cbodepanacipacifuat' id='cbodepanacipacifuat' tabindex='15' >
                                                                                      <option value='' selected='true'>
                                                                                    </select>
                                                                                ...
                                                                                <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                                   <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>PROVINCIA<span class="color-rojo"> (*)</span></label></div>    
                                                                                  <select class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='cboprovnacipacifuat' id='cboprovnacipacifuat' tabindex='16' >
                                                                                    <option value='' selected='true'>
                                                                                  </select>
                                                                                </div>
                                                                                <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                                     <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>DISTRITO<span class="color-rojo"> (*)</span></label></div>
                                                                                    <select class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='cbodistrinacipacifuat' id='cbodistrinacipacifuat' tabindex='17' >
                                                                                      <option value='' selected='true'>
                                                                                    </select>
                                                                                </div>
                                                                                <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                                     <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>PAIS<span class="color-rojo"> (*)</span></label></div>
                                                                                    <select class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='cbopaisnacipacifuat' id='cbopaisnacipacifuat' tabindex='18' >
                                                                                      <option value='' selected='true'>
                                                                                    </select>
                                                                                </div>
                                                                 </div>
                                                      ...
                                                      <div class='row'>   
                                                          <div class='panel-primary col-xs-12 col-sm-12 col-md-12 col-lg-12'> 
                                                              <div> <H2><label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label color-rojo'></label></H4> </div>
                                                              <div class='col-xs-11 col-sm-11 col-md-11 col-lg-11'>
                                                                 <div class='row'>
                                                                      <div id='mensacupo'>
                                                                  ...
                                                                  <div class='row'>    
                                                                        <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>PARENTESCO<span class="color-rojo"> (*)</span></label> </div>
                                                                             ...
                                                                             <select class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='cboapofuat' id='cboapofuat' tabindex='21'>
                                                                                    <option value='' selected='true'>
                                                                       ...
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>TIPO_DOCUMENTO<span class="color-rojo"> (*)</span></label> </div>
                                                                            <select class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='cbotipodocuapofuat' id='cbotipodocuapofuat' tabindex='22'>
                                                                                    <option value='' selected='true'>
                                                                       ...
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>NUMERO_DOCUMENTO<span class="color-rojo"> (*)</span></label> </div>
                                                                            <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtnrodocuapofuat' id='txtnrodocuapofuat'  tabindex='23' maxlength='20'>
                                                                       </div>
                                                                 ...
                                                                 <div class='row'>    
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>NOMBRE(S)<span class="color-rojo"> (*)</span></label> </div>
                                                                              <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtnomapofuat' id='txtnomapofuat'  tabindex='25'  maxlength='100'>
                                                                        </div>
                                                                       ...
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>APELLIDO_PATERNO<span class="color-rojo"> (*)</span></label> </div>
                                                                             <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtapepatapofuat' id='txtapepatapofuat'  tabindex='26'  maxlength='50'>
                                                                        </div>
                                                                       ...
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>APELLIDO_MATERNO<span class="color-rojo"> (*)</span></label> </div>
                                                                                <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtapematapofuat' id='txtapematapofuat'  tabindex='27' maxlength='50'>
                                                                        </div>
                                                                 ...
                                                                 <div class='row'>    
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>CORREO_ELECTRONICO<span class="color-rojo"> (*)</span></label> </div>
                                                                                <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtcorreoapofuat' id='txtcorreoapofuat'  tabindex='28' maxlength='200'>
                                                                        </div>
                                                                 
                                                                       <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>TELEFONO</label> </div>
                                                                                <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtteleapofuat' id='txtteleapofuat'  tabindex='29' maxlength='20'>
                                                                        </div>
                                                                 
                                                                        <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label'>CELULAR<span class="color-rojo"> (*)</span></label> </div>
                                                                            <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtceluapofuat' id='txtceluapofuat'  tabindex='30'  maxlength='20'>
                                                                        </div>
                                                                 </div>
                                                                 <div class='row'>    
                                                                        <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label' id='lbldniapepatmatnom'>DNI DEL PADRE Y/O MADRE<span class="color-rojo"> (*)</span></label> </div>
                                                                                <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtdniapepatmatnomapofuat' id='txtdniapepatmatnomapofuat'  tabindex='31' maxlength='20'>
                                                                        </div>
                                                                        <div class='col-xs-12 col-sm-9 col-md-9 col-lg-9'>
                                                                            <div> <label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label' id='lblapepatmatnom'>APELLIDOS Y NOMBRES DEL PADRE Y/O MADRE<span class="color-rojo"> (*)</span></label> </div>
                                                                                <input type='text' class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtapepatmatnomapofuat' id='txtapepatmatnomapofuat'  tabindex='32' maxlength='200'>
                                                                        </div>
                                                                 </div>
                                                             </div>
                                                        </div>
...
<!--
                                                    ...
                                                    -->
                                                      ...
                                                      <div class='row'>    
                                                        <div class='panel-primary col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                              <div> <H2><label class='col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label color-rojo'>DOCUMENTOS DIGITALES:</label></H4> </div>
                                                              <div class='col-xs-11 col-sm-11 col-md-11 col-lg-11'>
<!--
                                                                  <div class='row'>
                                                                                <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                        ...
                                                        <div class='panel-primary col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                              ...
                                                              <div class='col-xs-11 col-sm-11 col-md-11 col-lg-11'>
                                                                ...
                                                                <br>
                                                                  <div class='row'>
                                                                      <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                                            <textarea  class='col-xs-12 col-sm-12 col-md-12 col-lg-12 form-control'  name='textdetasolicita' id='textdetasolicita'  rows='5' tabindex='34' maxlength='1950'>
                                                                  ...
                                                                  <div class='row'>
                                                                    <!--
                                                                              ...
                                                                              -->
                                                                                ...
                                                                                <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                                                    <input type="checkbox" class='col-xs-12 col-sm-12 col-md-12 col-lg-12 form-control' id="chkaceptapacifuat" name="chkaceptapacifuat" data-off-color='danger' data-size='small' tabindex='32'>
                                                        ...
                                                        <div class='panel-primary col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                              ...
                                                              <div class='col-xs-11 col-sm-11 col-md-11 col-lg-11'>
                                                                ...
                                                                <br>
                                                                  <div class='row'>
                                                                        <div class='col-xs-12 col-sm-1 col-md-1 col-lg-1'>
                                                                                    <input type="checkbox" class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' id="chkaceptasolicitafuat" name="chkaceptasolicitafuat" data-off-color='danger' data-size='small' tabindex='33'>
                                                                        ...
                                                                        <div class='col-xs-12 col-sm-9 col-md-9 col-lg-9'>
                                                                                <textarea  class='col-xs-12 col-sm-2 col-md-2 col-lg-2 form-control' name='txtobsaceptasolicitafuat' id='txtobsaceptasolicitafuat'  tabindex='34' maxlength='2000' rows='4'>
                                                                                </textarea>
                                                    ...
                                                    <div class='form-group'> 
                                                      ...
                                                      <div class='row'>  
                                                         <div class='panel-primary col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                            ...
                                                            <div class='col-xs-12 col-sm-2 col-md-1 col-lg-1' align='center'>  
                                                                            <button type='button' name='btaceptarfuat' id='btaceptarfuat' class='btn btn-primary btn-xs' tabindex='35'><i class='glyphicon glyphicon-floppy-disk'></i> Grabar</button>
                                                            </div>  
                                                            <div class='col-xs-12 col-sm-2 col-md-1 col-lg-1' align='center'>  
                                                                            <button type='button' name='btcancefuat' id='btcancefuat' class='btn btn-primary btn-xs'
                                                                             data-dismiss='modal' tabindex='36'><i class='glyphicon glyphicon glyphicon-repeat'></i> Cancelar</button>
                                                            </div>
                                                            <!--
           ...
           $('#frmfuat').ready(function(){
                    ...
                    rules:  {
                          ...
                          //    txtcorreopacifuat: {required:true, maxlength:100}, //correo
                           //   txtcelupacifuat: {required:true, maxlength:20}, //celular
                              ...
                              txtnomapofuat: {required:true,maxlength:100}, //nombre apoderado
               ...
               function consutecla(evento,control1,control2)
                  ...
                  $("#txtfechanacipacifuat").keypress(function(e){
                      consutecla(e,$("#txtfechanacipacifuat")[0],$("#txtnompacifuat")[0]);
                  });  
                  ...
                  $("#txtedadpacifuat").keypress(function(e){
                      consutecla(e,$("#txtedadpacifuat")[0],$("#cbodepapacifuat")[0]);
                  });
...
/*                
                  ...
                  */
                  ...
                  $("#cboapofuat").keypress(function(e){
                      consutecla(e,$("#cboapofuat")[0],$("#cbotipodocuapofuat")[0]);
                  });

                  $("#txtnomapofuat").keypress(function(e){
                      consutecla(e,$("#txtnomapofuat")[0],$("#txtapepatapofuat")[0]);
                  });  
                  ...
                  $("#txtcorreoapofuat").keypress(function(e){
                      consutecla(e,$("#txtcorreoapofuat")[0],$("#txtteleapofuat")[0]);
                  });  
                  $("#txtteleapofuat").keypress(function(e){
                      consutecla(e,$("#txtteleapofuat")[0],$("#txtceluapofuat")[0]);
                  });  
                  $("#txtceluapofuat").keypress(function(e){
                      consutecla(e,$("#txtceluapofuat")[0],$("#txtdniapepatmatnom")[0]);
                  });  
                 ...
                 if ($("#cboapofuat").prop('value')=='1')
                   {
                    ...
                    $("#lblapepatmatnom").html('APELLIDOS Y NOMBRES DEL PADRE<span class="color-rojo"> (*)</span>');   
                   }
                  else if ($("#cboapofuat").prop('value')=='2')
                   {
                    $("#lbldniapepatmatnom").html('DNI DE LA MADRE<span class="color-rojo"> (*)</span>');   
                    $("#lblapepatmatnom").html('APELLIDOS Y NOMBRES DE LA MADRE<span class="color-rojo"> (*)</span>');   
                   }
                  else if ($("#cboapofuat").prop('value')=='3')
                   {
                    $("#lbldniapepatmatnom").html('DNI DE PADRE Y DE MADRE<span class="color-rojo"> (*)</span>');   
                    $("#lblapepatmatnom").html('APELLIDOS Y NOMBRES DE PADRE Y DE MADRE<span class="color-rojo"> (*)</span>');   
                   }
                });
            ...
            $('#cbodistripacifuat').focus(function () {
             ...
             $('#txtservipacifuat').change(function () {
              ...
              $('#cbotipopacifuat').prop('value','');
               ...
               $('#mensacupo').hide();
               $('#mensaservi').hide();
         //      alert($('#txtservipacifuat').prop('value'));

                var cadena1='';
                var cadena2='';
                cupos=false;
                $.ajax({async:false, cache:false, url : 'consulta.php', data :{ cade1:$('#txtservipacifuat').prop('value'), cade2:'', opc1:'fuat', opc2 : 'consucupofuat'}, type : 'POST',dataType : 'json',success : function(data)
                  {  
                      $.each(data, function(i){
              ...
              $('#cbotipopacifuat').change(function () {
                if ( $('#txtservipacifuat').prop('value')!='150804' && $('#cbotipopacifuat').prop('value')=='3' ) //no Triaje Medico y Gratuito
                  {
                         ...
                         { 
                            ...
                            if (rpta == true)  
                                ...
                                */
                                      ...
                                      edadfuat = $('#txtapematpacifuat').prop('value').trim().toUpperCase();
                                      ...
                                      //puestosupefic = "";
                                        ...
                                        */
                                        ...
                                        if($('#txtotrosespefuat').prop('value').trim().length>0)
                                        {
                                            otrosespefuat = $('#txtotrosespefuat').prop('value').trim().toUpperCase();
                                        } 
                                      else
                                        {
                                           otrosespefuat = ''; 
...
*/
                                          otrosespefuat= $('#txtedadpacifuat').prop('value').trim().toUpperCase();
                               ...
                               //alert(tipodiag2fuat);
                                // alert( $('#txtapepatpacifuat').prop('value').trim().toUpperCase());
                                      ...
                                      $.ajax({async:false, cache:false, url : 'consulta.php', data :{ codifuat:codifuat, usuemifuat:usuemifuat
                                        ...
                                        , edadfuat:edadfuat, codiservifuat:codiservifuat, dnipacifuat:dnipacifuat, codijefeinmefic:codijefeinmefic 
                                        , codijefesupefic:codijefesupefic, puestosupefic:puestosupefic
                                        , otrosdocufuat:otrosdocufuat, otrosespefuat:otrosespefuat
                                        , desccasofuat:desccasofuat
                                        , trataactualfuat:trataactualfuat, exaapodiagfuat:exaapodiagfuat, moticonsufuat:moticonsufuat, nomipressconsufuat:nomipressconsufuat, codiipressconsufuat:codiipressconsufuat
                                        , codidiag1fuat:codidiag1fuat, coordiexterfic:coordiexterfic, horatelefuat:horatelefuat, fechatelefuat:fechatelefuat
                                        , sexofuat:sexofuat, resusolifuat:resusolifuat, espefuat:espefuat, ofiotrosfic:ofiotrosfic, inglesfic:inglesfic, otrosfic:otrosfic
                                        //, recofuat:recofuat
                                        ...
                                        ,tipodocuapofuat:tipodocuapofuat,nrodocuapofuat:nrodocuapofuat,fechanaciapofuat:fechanaciapofuat,nomapofuat:nomapofuat
                                        ,apepatapofuat:apepatapofuat,apematapofuat:apematapofuat,correoapofuat:correoapofuat,teleapofuat:teleapofuat,celuapofuat:celuapofuat
