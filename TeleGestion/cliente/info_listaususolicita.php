<?php
  ...
  class PDF extends FPDF
      ...
      function Header()
       {
          ...
          $this->Cell(98,10,'',0);
          $this->Cell(1,10,'LISTA DE SOLICITUD DE CITAS POR USUARIO',0);
          $this->Cell(145,10,'',0);
          ...
          $this->image('../cliente/images/excel.gif',273,22,5,5,'gif','../cliente/expolistaususolicita.php');
          ...
          $this->Cell(160,10,'----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------',0);
          $this->ln(5);
          $this->Cell(100,10,'NRO | CODIGO |  NRO DOCU  | APELLIDOS Y NOMBRE(S) DEL PACIENTE                             |  FECHA EMISION  |             ESPECIALIDAD             |  FECHA USUARIO   |  USUARIO  |  ACEPTA  |  TIPOPACI',0);
          $this->ln(5);
          $this->Cell(160,10,'----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------',0);
          $this->ln(5);
        }
    ...
    $arrayinfo = $clsnegocio->finfo($_SESSION['fechaimpre'],'','','','infolistausufuat',''); 
    $nro=1;
    if($arrayinfo) 
      {
        foreach ($arrayinfo as $datainfo):
          ...
          $pdf->Cell(84,5,' ',0);
          $pdf->Cell(1,5,$datainfo['fechaemi'],0,0,'L');
          ...
          $pdf->Cell(20,5,' ',0);
          $pdf->Cell(1,5,$datainfo['usuactu'],0,0,'L');

          $pdf->Cell(25,5,' ',0);
          $pdf->Cell(1,5,$datainfo['acepta'],0,0,'C');

          $pdf->Cell(8,5,' ',0);
          $pdf->Cell(1,5,$datainfo['tipopaci'],0,0,'L');
